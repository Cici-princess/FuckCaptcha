...
tf.app.flags.DEFINE_string('test_data_dir', '../data/run_testing/', 'the run_testing dataset dir')
tf.app.flags.DEFINE_string('log_dir', './log', 'the logging dir')

tf.app.flags.DEFINE_boolean('restore', False, 'whether to restore from checkpoint')
tf.app.flags.DEFINE_boolean('epoch', 1, 'Number of epoches')
tf.app.flags.DEFINE_boolean('batch_size', 128, 'Validation batch size')
tf.app.flags.DEFINE_string('mode', 'train', 'Running mode. One of {"train", "valid", "run_testing"}')
...
def train():
    ...
    test_feeder = DataIterator(data_dir='../data/run_testing/')
        ...
        try:
            while not coord.should_stop():
                ...
                if step % FLAGS.eval_steps == 1:
                    ...
                    logger.info('the step {0} run_testing accuracy: {1}'
...
def main(_):
    ...
    if FLAGS.mode == "train":
        ...
        image_path = '../data/run_testing/00190/13320.png'
