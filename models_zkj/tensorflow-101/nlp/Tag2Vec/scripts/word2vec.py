...
flags.DEFINE_integer("batch_size", 16,
                     "Number of training pytorch-official-examples processed per step "
                     "(size of a minibatch).")
...
class Options(object):
    ...
    def __init__(self):
        ...
        # Number of pytorch-official-examples for one training step.
...
class Word2Vec(object):
    ...
    def forward(self, examples, labels):
        ...
        # Embeddings for pytorch-official-examples: [batch_size, emb_dim]
        ...
        # We replicate sampled noise labels for all pytorch-official-examples in the batch
        # using the matmul.
